...
public class TestTorneo {
    ...
    public void testAgregarPartidoAOtroTorneo() throws NoxitException {
        ...
        Partido partido = new Partido(torneo1, equipo1, equipo2, 1, 1, 1, now.plusDays(1), now);
    ...
    public void testAgregarDosVecesPartido() throws NoxitException {
        ...
        LocalDateTime now = new LocalDateTime();
        Partido partido = equipo1.jugarContra(torneo, equipo2, 1, 1, 1, now.plusDays(1), now);
